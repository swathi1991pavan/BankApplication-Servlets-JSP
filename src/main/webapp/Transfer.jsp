...
<div class="background-image">
	...
	<div>
	<h1 class="form-heading">Transfer Amount</h1>
	</div>
	<div>
		<form  action="TransferServlet" class="form" method="post">

<table>
 <tr>
    <td>From AccountNo::</td>
    <td><input type="text" name="ownerAccNo" value="${userid}" readonly></td>
   </tr>
   <tr>
    <td>To AccountNo::</td>
    <td><input type="text" name="transferAccNo" placeholder="Enter here"></td>
   </tr>
   <tr>
    <td>Transfer Amount :</td>
    <td><input type="text" name="transferAmount" placeholder="Enter here"></td>
   </tr>
   <tr>
    <td></td><td><input type="submit" value="Continue" class="button"></td>
   </tr>
   </table>
</form>
